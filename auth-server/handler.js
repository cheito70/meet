...
/**
 * Scopes allows you to set access levels; this is set to readonly for now because
 * you don't have access rights to update the calendar yourself.
 * For more info, check out scopes documentation 
...
const credentials = {
  ...
  redirect_uris: ["https://cheito70.github.io/meet"],
  javascript_origins: ["https://cheito70.github.io", "http://localhost:3000"],
};
...
//The values used to indtantate the OAuthClient are at the top of file
  const oAuth2Client = new google.auth.OAuth2(
    client_id,
    client_secret,
    redirect_uris[0]
